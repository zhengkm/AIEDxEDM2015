...
public class TutorialDetail extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intent.putExtras(b1);
        TabHost.TabSpec detail = host.newTabSpec("Detail");
        ...
        intent.putExtras(b1);
        TabHost.TabSpec attending = host.newTabSpec("Attending");
        ...
        intent.putExtras(b1);
        TabHost.TabSpec similar = host.newTabSpec("Similar");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case MENU_HOME:
                this.finish();
                itemintent.setClass(TutorialDetail.this, MainInterface.class);
                startActivity(itemintent);
                return true;
            case MENU_SESSION:
                this.finish();
                itemintent.setClass(TutorialDetail.this, ProgramByDay.class);
                startActivity(itemintent);
                return true;
            case MENU_STAR:
                this.finish();
                itemintent.setClass(TutorialDetail.this, MyStaredPapers.class);
                startActivity(itemintent);
                return true;
            case MENU_TRACK:
                this.finish();
                itemintent.setClass(TutorialDetail.this, Proceedings.class);
                startActivity(itemintent);
                return true;
            case MENU_SCHEDULE:
                this.finish();
                itemintent.setClass(TutorialDetail.this, MyScheduledPapers.class);
                startActivity(itemintent);
                return true;
            case MENU_RECOMMEND:
                this.finish();
                itemintent.setClass(TutorialDetail.this, MyRecommendedPapers.class);
                startActivity(itemintent);
                return true;
        }
        return false;
